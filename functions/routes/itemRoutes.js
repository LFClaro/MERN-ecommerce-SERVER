...
router.get("/:id", authMiddleware, async (req, res) => {
  try {
    ...
    const itemAndUser = Object.assign({}, {"queryUser": userID}, itemDB);
    // Adding User who querid to the JSON response
...
router.post(
    ...
    async (req, res) => {
      ...
      // find Profile by id, mainly want the geolocation

      // Using the Cloudinary helper function to
      // place the file in the cloud server
...
router.put(
    ...
    async (req, res) => {
      ...
      if (req.files) {
        ...
        // to place the file in the cloud server
